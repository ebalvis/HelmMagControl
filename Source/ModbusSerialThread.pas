...
type
  ...
  // Estructura para comandos de escritura as�ncrona
  ...
  private
    ...
    // MEJORA: Nueva funci�n optimizada
...
var
  ...
  TimePerChar: Double;
begin
  // Bits por car�cter = data bits + start bit + stop bits + parity bit (si existe)
  ...
  // Tiempo de 3.5 caracteres (est�ndar Modbus RTU)
  Result := Round(TimePerChar * 3.5);

  // M�nimo 2ms, m�ximo 20ms
  if Result < 2 then
    Result := 2
...
begin
  ...
  try
    ...
    // MEJORA CR�TICA: Timeouts optimizados para Modbus RTU
    FillChar(Timeouts, SizeOf(Timeouts), 0);

    // ReadIntervalTimeout: tiempo m�ximo entre bytes
    // Usar tiempo de 1.5 caracteres para detectar fin de trama r�pidamente
    ...
    // Timeouts de escritura m�s cortos
...
// MEJORA CR�TICA: Nueva funci�n de lectura optimizada
...
begin
  ...
  // Tiempo entre caracteres (1.5 caracteres seg�n Modbus RTU)
  ...
  try
    ...
    begin
      ...
      begin
        ...
        // Si hemos le�do suficiente, salir
...
begin
  ...
  try
    ...
    // MEJORA: Usar funci�n de lectura optimizada
...
begin
  ...
  try
    ...
    // MEJORA: Usar funci�n optimizada
...
// M�todos para agregar comandos de escritura
